...
import com.example.maincalculator.ui.theme.Purple700
...
fun CalculatoraScreen(){
    ...
    Column(Modifier.padding(15.dp)) {
        TextField(
            ...
            label = { Text(text = "Insira um valor:")},
        ...
        TextField(
            ...
            label = { Text(text = "Insira o segundo valor:")},
            keyboardOptions = KeyboardOptions.Default.copy(
                keyboardType = KeyboardType.Number
            ),
            modifier = Modifier.fillMaxWidth()
        ...
        Row(
            ...
            Button(modifier = Modifier.padding(5.dp), colors = ButtonDefaults.buttonColors(backgroundColor = Red),onClick = {
                value1 = ""
                value2 = ""
                operator = ""
                result = ""
